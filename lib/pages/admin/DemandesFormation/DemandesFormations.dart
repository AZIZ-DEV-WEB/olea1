...
import 'AdminPendingRequests.dart' hide oleaPrimaryReddishOrange;
import 'HistoriquesDemandes.dart' hide oleaPrimaryReddishOrange;
...
class Demandesformations extends StatefulWidget {
  const Demandesformations({super.key});

  @override
  State<Demandesformations> createState() => DemandesformationsState();
}

class DemandesformationsState extends State<Demandesformations> {
  String? _username;
            ...
            _buildDashboardCard(
              ...
              cardWidth,
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  AdminPendingRequests()),
                );
                if (mounted) setState(() {});
              },
            ),
