...
import 'package:firstproject/pages/admin/admin_users_page.dart' hide oleaPrimaryReddishOrange;
import 'package:firstproject/pages/user/userProfile.dart';
import 'package:flutter/material.dart';
import '../../../services/auth.dart';
import '../../../widgets/custom_app_bar.dart';
import 'DemandesEnAttente.dart';
import 'DeposerDemande.dart';
import 'DemandesHistoriques.dart';
...
class DemandesDashboard extends StatefulWidget {
  const DemandesDashboard({super.key});

  @override
  State<DemandesDashboard> createState() => DemandesDashboardState();
}

class DemandesDashboardState extends State<DemandesDashboard> {
  String? _username;
          ...
          children: [
            ...
            _buildDashboardCard(
              ...
              cardWidth,
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  DemandesEnAttente()),
                );
                if (mounted) setState(() {});
              },
            ),
            ...
            _buildDashboardCard(
              ...
              cardWidth,
                ...
                await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  Demandeshistoriques()),
                );
                if (mounted) setState(() {});
              },
            ),
